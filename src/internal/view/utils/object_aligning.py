    ...
    for item in top:
        ...
        if obj_frame[0] == obj_x1:
            dependencies.canvas.create_line(
                obj_x1, obj_y1, obj_frame[0], obj_frame[3], tags=[ID], fill=COLOR
            )
            break
        if obj_frame[0] == obj_x2:
            dependencies.canvas.create_line(
                obj_x2, obj_y1, obj_frame[0], obj_frame[3], tags=[ID], fill=COLOR
            )
            break
        if obj_frame[1] == obj_x1:
            dependencies.canvas.create_line(
                obj_x1, obj_y1, obj_frame[1], obj_frame[3], tags=[ID], fill=COLOR)
            break
        if obj_frame[1] == obj_x2:
            dependencies.canvas.create_line(
                obj_x2, obj_y1, obj_frame[1], obj_frame[3], tags=[ID], fill=COLOR
            )
            break
    else:
        ...
        for item in bottom:
            ...
            if obj_frame[0] == obj_x1:
                dependencies.canvas.create_line(obj_frame[0], obj_frame[3], obj_x1, obj_y1,
                                                tags=[ID],
                                                fill=COLOR)
                break
            if obj_frame[0] == obj_x2:
                dependencies.canvas.create_line(obj_frame[0], obj_frame[3], obj_x2, obj_y1,
                                                tags=[ID],
                                                fill=COLOR)
                break
            if obj_frame[2] == obj_x1:
                dependencies.canvas.create_line(obj_frame[2], obj_frame[3], obj_x1, obj_y1,
                                                tags=[ID],
                                                fill=COLOR)
                break
            if obj_frame[2] == obj_x2:
                dependencies.canvas.create_line(
                    obj_frame[2], obj_frame[3], obj_x2, obj_y1, tags=[ID], fill=COLOR
                )
                break
        ...
        for item in left:
            ...
            if obj_frame[1] == obj_y1:
                dependencies.canvas.create_line(
                    obj_x1, obj_y1, obj_frame[2], obj_frame[1], tags=[ID], fill=COLOR
                )
                break
            if obj_frame[1] == obj_y2:
                dependencies.canvas.create_line(
                    obj_x1, obj_y2, obj_frame[2], obj_frame[1], tags=[ID], fill=COLOR
                )
                break
            if obj_frame[3] == obj_y1:
                dependencies.canvas.create_line(
                    obj_x1, obj_y1, obj_frame[2], obj_frame[3], tags=[ID], fill=COLOR
                )
                break
            if obj_frame[3] == obj_y2:
                dependencies.canvas.create_line(
                    obj_x1, obj_y2, obj_frame[2], obj_frame[3], tags=[ID], fill=COLOR
                )
                break
        else:
            ...
            for item in right:
                ...
                if tags[0] == obj_id:
                    continue
                obj_x1, obj_y1, obj_x2, obj_y2 = dependencies.canvas.bbox(tags[0])
                if not (obj_y1 in [obj_frame[1], obj_frame[3]] or obj_y2 in [obj_frame[1],
                                                                             obj_frame[3]]):
                    continue

                if obj_frame[1] == obj_y1:
                    dependencies.canvas.create_line(
                        obj_frame[2], obj_frame[1], obj_x1, obj_y1, tags=[ID], fill=COLOR
                    )
                    break
                if obj_frame[1] == obj_y2:
                    dependencies.canvas.create_line(
                        obj_frame[2], obj_frame[1], obj_x1, obj_y2, tags=[ID], fill=COLOR
                    )
                    break
                if obj_frame[3] == obj_y1:
                    dependencies.canvas.create_line(
                        obj_frame[2], obj_frame[3], obj_x1, obj_y1, tags=[ID], fill=COLOR)
                    break
                if obj_frame[3] == obj_y2:
                    dependencies.canvas.create_line(
                        obj_frame[2], obj_frame[3], obj_x1, obj_y2, tags=[ID], fill=COLOR
                    )
                    break
