...
def _get_font(
    ...
    font = dependencies.canvas.itemcget(TEXT_PREFIX + obj_id, 'font')
    font = font.split()
    font[1] = int(font[1])
...
def _set_font_slant(
    ...
    font = _get_font(dependencies, obj_id)
    font[3] = value
    dependencies.canvas.itemconfig(TEXT_PREFIX + obj_id, font=tuple(font))
...
def _get_color(
    ...
    return dependencies.canvas.itemcget(TEXT_PREFIX + obj_id, 'fill')
...
def _set_color(
    ...
    dependencies.canvas.itemconfig(TEXT_PREFIX + obj_id, fill=color)
